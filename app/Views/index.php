            ...
            <div class="slider-content">
                ...
                <div class="slider slider-v1" data-cycle-swipe=true data-cycle-prev=".prevControl" data-cycle-next=".nextControl" data-cycle-loader="wait">
                    ...
                    <div class="slider-item slider-item-img1">
                        ...
                        <img src="assets/user/images/slider/slider1.jpg" class="img-responsive parallaximg sliderImg" alt="img">
                    </div>
                    <!--/.slider-item-->
                    ...
                    <div class="slider-item slider-item-img3 ">
                        ...
                        <img src="assets/user/images/slider/slider4.jpg" class="img-responsive parallaximg sliderImg" alt="img">
                    </div>
                    <!--/.slider-item-->
                    ...
                    <div class="slider-item slider-item-img3">
                        <div class="sliderInfo">
                            <div class="container">
                                <div class="col-lg-5 col-md-6 col-sm-5 col-xs-5 pull-left sliderText blankstyle transformRight">
                                    <div class="inner text-right"><img src="assets/user/images/slider/color.png" class="img-responsive" alt="img"></div>
                                </div>
                        ...
                        <img src="assets/user/images/slider/6.jpg" class="img-responsive parallaximg sliderImg" alt="img">
                    </div>
                </div>
                <!--/.slider slider-v1-->
            </div>
                ...
                <div class="item">
                    <div class="product">
                        ...
                        <div class="image">
                            ...
                            <a href="product-details.html"><img src="assets/user/images/product/36.jpg" alt="img" class="img-responsive"></a>
    ...
    <footer>
        ...
        <div class="footer-bottom">
            <div class="container">
                ...
                <div class="pull-right paymentMethodImg"><img height="30" class="pull-right" src="images/site/payment/master_card.png" alt="img"> <img height="30" class="pull-right" src="images/site/payment/visa_card.png" alt="img"><img height="30" class="pull-right" src="images/site/payment/paypal.png" alt="img">
