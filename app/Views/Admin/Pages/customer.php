               ...
               <div class="col-md-4">
                    <form action="admin/customer/create" method="POST">
                         <div class="mb-4">
                              ...
                              <input type="text" placeholder="Type here" class="form-control" id="sTenKH" name="sTenKH"/>
                         </div>
                         <div class="mb-4">
                         ...
                         <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div>
                                    <input type="number" class="form-control" placeholder="012345678" name="iTichDiem">
                                </div> <!-- col.// -->
                            </div> <!-- row.// -->
                         </div>
                         <div class="mb-4">
